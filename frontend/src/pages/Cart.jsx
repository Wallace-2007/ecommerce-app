...
const Cart = () => {
  ...
  return (
    <div className='border-t pt-14'>
      ...
      <div>
        {cartData.length > 0 ? ( // Verifica se cartData tem itens
          cartData.map((item, index) => {
            const productData = products.find((product) => product._id === item._id);

            return productData ? ( // Verifica se productData não é undefined
                ...
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-5 mt-2'>
                      ...
                      <p className='px sm:px-3 sm:py-1 border bg-slate-50'>{item.size}</p>
                    </div>
                  </div>
                </div>
                <input 
