  ...
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
      ...
      <div>
        ...
        <p className='text-gray-400'>Oferecemos uma política de troca gratuita de 7 days</p>
      </div>

      <div>
        <img src={assets.support_img} className='w-12 m-auto mb-5' alt="" />
        <p className='font-semibold '>Melhor Suporte ao Cliente</p>
        <p className='text-gray-400'>Oferecemos suporte ao cliente 24 horas por dia,<br/>7 dias por semana</p>
      </div>
